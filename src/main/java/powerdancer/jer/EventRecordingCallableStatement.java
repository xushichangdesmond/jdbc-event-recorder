...
public class EventRecordingCallableStatement extends EventRecordingPreparedStatement implements CallableStatement {
    final CallableStatement delegate;
    final String sql;

    public EventRecordingCallableStatement(CallableStatement callableStatement, String sql) {
